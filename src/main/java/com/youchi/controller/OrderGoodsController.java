...
public class OrderGoodsController  {
   ...
   /**
    ...
    public ResponseMessage selectAll(@PathVariable(value = "size") int size,
     ...
     final List<OrderGoods> page1 = orderGoodsMapper.page((num - 1) * size, size);
        Map<String, Object> map = new HashMap<>();;
        map.put("records", page1);
        map.put("total", orderGoodsMapper.count());
    ...
    public ResponseMessage selectOne(@PathVariable(value = "id") Long id) {
        return ResponseMessage.success(orderGoodsMapper.findById(id));
    }
...
//     @ApiOperation("新增数据")
//    @PostMapping("add")
//    public ResponseMessage insert(@RequestBody OrderGoods orderGoods) {
...
//    }
     ...
     */
     @ApiOperation("修改数据")
    @PostMapping("modify")
    public ResponseMessage update(@RequestBody OrderGoods orderGoods) {
